...
alias task='nbjob_run_feeder --target sc_normal3 --qslot /DCSG/fe/rgr/gnrio/regress --class "SLES11SP4&&62G"'
alias fgptask='nbjob_run_feeder --target sc_normal3 --qslot /DCSG/fe/rgr/gnrio/regress --class "SLES11SP4&&5C&&62G&&!SANDYBRIDGE&&!CASCADELAKE&&!HASWELL&&!WESTMERE&&!NEHALEM"'
alias ijob="nbjob run --target sc_normal3 --qslot /DCSG/fe/rgr/gnrio/regress --mode interactive --class 'SLES11SP4&&62G'"
alias job="nbjob run --target sc_normal3 --qslot /DCSG/fe/rgr/gnrio/regress --class 'SLES11SP4&&62G'"
